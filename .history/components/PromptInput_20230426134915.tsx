    ...
    <div className="m-10">
        <form className="flex flex-col lg:flex-row shadow-md shadow-slate-400/10 rounded-md lg:divide-x">
            ...
            <button 
                type="submit"
                disabled={!input}
                className={`p-4 font-bold ${input ? 'bg-orange-500 text-white transition-colors duration-200'
            ...
            <button
                ...
                rounded-b-md md:rounded-r-md md:rounded-bl-none font-bold rounded  "
            >
                New Suggestion
            </button>
        </form>
